<template>
    <tab-bar>
      <tab-bar-item path="/home">
        ...
        <template v-slot:item-icon-acitve><img src="~assets/img/tabbar/home_active.svg" alt=""> </template>
      ...
      <tab-bar-item path="/category">
        ...
        <template v-slot:item-icon-acitve><img src="~assets/img/tabbar/category_active.svg" alt=""></template>
      ...
      <tab-bar-item path="/shopcart">
        ...
        <template v-slot:item-icon-acitve><img src="~assets/img/tabbar/shopcart_active.svg" alt=""></template>
      ...
      <tab-bar-item path="/profile">
        ...
        <template v-slot:item-icon-acitve><img src="~assets/img/tabbar/profile_active.svg" alt=""></template>
